...
<body>
			...
			<div class="container">
				...
				<div class="logo-nav">
					<div class="logo-nav-left">
						<h1><a>husnudzon food <span>kenikmatan berbaik sangka</span></a></h1>
					</div>
					...
					<div class="logo-nav-right">
						...
						</ul> <!-- search button 'cd-header-buttons -->
	...
	<!--banner-->
	<div class="banner1">
			<h3><a>Home</a> / <span>Products</span></h3>
	</div>
<!--banner-->
	<!--content-->
		<div class="content">
					...
					<div class="product-agileinfo-grids w3l">
						<div class="col-md-3 product-agileinfo-grid">				
							<div class="brand-w3l">
								...
								<ul>
									<li><a href="#">Aman</a></li>
									<li><a href="#">Siaga</a></li>
									<li><a href="#">Waspada</a></li>
						...
						<div class="col-md-9 product-agileinfon-grid1">
							...
							<div class="mens-toolbar">
								<p >Showing 1–9 of 21 results</p>
								 <p class="showing">urutkan berdasar
									<select>
