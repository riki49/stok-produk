...
<body>
	<!--header-->
		...
		<div class="banner1">
			<div class="container">
				<h3><a href="<?php echo base_url('reseller') ?>">Reseller</a> / <span>Mail</span></h3>
			</div>
		</div>
		<!--banner-->
			<!--content-->
							...
							<h2 class="tittle">Mail Us</h2>
								<div class="mail-bottom">
									<form action="<?php echo base_url('reseller/sendMail')?>" method="post">
										<input name="username" type="text"  value="<?php echo $nama ?>" >
										<input name="email" type="email" readonly value="<?php echo $email ?>">
										<!-- <input id="telephon" type="" placeholder="telephon"> -->
