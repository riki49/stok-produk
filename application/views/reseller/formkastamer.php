...
<section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
        <a href="<?php echo base_url()?>kastamer"><button type="button" class="btn bg-olive btn-flat margin"><- Kembali</button></a>
            <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Form Kastamer</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="#" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">ID Kastamer</label>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Kastamer</label>
